...
from project_system.skills import SKILLS_ERA_PROJECT_CLI_VERSION
...
def test_new_project_records_skills_era_cli_target(tmp_path):
    root=init_project('Demo',tmp_path/'demo','other','solo')
    assert load_yaml(root/'project.yaml')['tooling']['project_cli']==SKILLS_ERA_PROJECT_CLI_VERSION
